# [SOLVED] The-Select-Permission-Was-Denied-On-The-Object-39-Users-39-D
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/the-select-permission-was-denied-on-the-object-39-users-39-d)
>
...
Check the Azure portal for the database and ensure that the 'test' user has the necessary permissions, specifically 'SELECT' on the 'dbo' schema.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/the-select-permission-was-denied-on-the-object-39-users-39-d)**
